-- Real product images, verified 200 + image/*, resized for performance (~90% smaller than originals).

update public.products set image_url = 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c6/Sony-WH-1000XM3-kabellose-Bluetooth-Noise-Cancelling-Kopfhoerer.4.jpg/600px-Sony-WH-1000XM3-kabellose-Bluetooth-Noise-Cancelling-Kopfhoerer.4.jpg' where name = 'Noise Cancelling Over-Ear Headphones';
